         ...
         <nav class="navbar navbar-expand-lg bg-white fixed-top scrolling-navbar">
            <div class="container">
               ...
               <div class="collapse navbar-collapse" id="main-navbar">
                  <ul class="navbar-nav mr-auto w-100 justify-content-center">
                     ...
                     <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                           <a class="dropdown-item" href="#">Ad Grid</a>
                           <a class="dropdown-item" href="#">Ad Listing</a>
                           <a class="dropdown-item" href="#">Listing Detail</a>
                        </div>
                     </li>
                     <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" aria-haspopup="true"
                  ...
                  <div class="post-btn">
                     <a class="btn btn-common" href="post-ads.html"><i class="lni-pencil-alt"></i>Become Agent with
                     us</a>
                  </div>
               </div>
            </div>
                                    ...
                                    <div class="tab-content" id="main_form">
                                       <div class="tab-pane active" role="tabpanel" id="step1">
                                          <div class="form-input-steps">
                                             ...
                                             <form>
                                               <div class="form-row">
                                                 <div class="form-group leff__bootm col-md-12">
                                                   <h6 class="label__css">Date of birth</h6>
                                                <input type="date" class="form-control" name="" placeholder="Eg. i20, beat">
                                                 </div>
                                                  
                                               </div>  
                                             </form>
                                             <div class="form-group leff__bootm"> 
                                                <h6 class="label__css">Gender</h6>
                                                <div class="row">
                                                   <div class="col-md-2">
                                             ...
                                             <div class="form-group leff__bootm"> 
                                                <h6 class="label__css">Approx. annual Income</h6>
                                                <select class="form-control see__css"> 
                                                   <option>Less than 3 Lac</option>
                                                   <option>5 Lac to 7 Lac</option>
                                                   <option>7 Lac to 10 Lac</option>
                                                   <option>5 Lac to 7 Lac</option>
                                                   <option>7 Lac to 10 Lac</option>
                                                   <option>5 Lac to 7 Lac</option>
                                                   <option>7 Lac to 10 Lac</option>
                                             ...
                                             <div class="form-group leff__bootm"> 
                                                <h6 class="label__css">What age are you planning to retire?</h6>
                                                <select class="form-control see__css"> 
                                       ...
                                       <div class="tab-pane" role="tabpanel" id="step2">
                                          <div class="form-input-steps">
                                             ...
                                             <h3>How much would you like to invest?</h3>
                                              ...
                                              <form>
                                               <div class="form-row">
                                                 <div class="form-group leff__bootm col-md-6">
                                                   <h6 class="label__css">Invest</h6>
                                                     <select class="form-control see__css"> 
                                                    ...
                                                    <div class="form-group leff__bootm col-md-6">
                                                   <h6 class="label__css">Amount</h6>
                                                      <input type="text" class="form-control" name="" placeholder="24332">
                                                    </div>
                                                    <div class="form-group leff__bootm col-md-12">
                                                   <h6 class="label__css">Invest for, i.e. premium paying term (PPT)</h6>
                                                      <select class="form-control see__css"> 
                                       ...
                                       <div class="tab-pane" role="tabpanel" id="step3">
                                          <div class="form-input-steps">
                                             <h4>Life Profile <br> <span class="text-danger">Saved quotes will be sent to you via email or sms</span>  </h4>
                                             <h3>Save your quote now</p> </h3>
                                          ...
                                          <ul class="list-inline text-right">
                                             ...
                                             <li>
                                                <a href="pension-retirement-dashboard.html" class="step-btn next-step"><span>NEXT</span><i class="fa fa-chevron-right"></i></a>
                                             </li>
                                          </ul>
                                       </div>
