                                    ...
                                    <div class="tab-content" id="main_form">
                                       <div class="tab-pane active" role="tabpanel" id="step1">
                                          <div class="form-input-steps">
                                             ...
                                             <div class="form-group leff__bootm"> 
                                                <h6 class="label__css">Smoke or Chew Tobacco</h6>
                                                <div class="row">
                                                   <div class="col-md-2">
                                                      <div class="form-check">
                                                   <input class="form-check-input" type="checkbox" id="gridCheck">
                                       ...
                                       <div class="tab-pane" role="tabpanel" id="step2">
                                          <div class="form-input-steps">
                                             <h4>Life Profile</h4>
                                             <h3>Select the Sum Assured Amount</h3>
                                              
                                              <form>
                                               <div class="form-row">
                                                 <div class="form-group leff__bootm col-md-12">
                                                   <h6 class="label__css">Sum Assured Amount</h6>
                                                <select class="form-control see__css"> 
                                                   <option>Less than 3 Lac</option>
                                                   <option>5 Lac to 7 Lac</option>
                                                   <option>7 Lac to 10 Lac</option>
                                       ...
                                       <div class="tab-pane" role="tabpanel" id="step3">
                                          ...
                                          <ul class="list-inline text-right">
                                             ...
                                             <li>
                                                <a href="terms-life-dashboard.html" class="step-btn next-step"><span>NEXT</span><i class="fa fa-chevron-right"></i></a>
                                             </li>
                                          </ul>
                                       </div>
