                        ...
                        <div class="col-lg-4">
                            <div class="page-header-breadcrumb">
                                <ul class="breadcrumb-title">
                                    ...
                                    <li class="breadcrumb-item" style="float: left;">
                                        <a href="#!">Edit Your Achievements</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                            ...
                            <div>
                                <div>
                                    <div class="items" data-group="test">
                                        <div class="card">
                                            <div class="card-body">
                                                <form class="row g-3" method="post" enctype="multipart/form-data" action="{{route('your-achivements.update',$data->id)}}">
                                                    @csrf
                                                    {{ method_field('post') }}
