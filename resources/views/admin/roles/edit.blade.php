                      ...
                      <div class="card-body">
                        <div class="d-flex flex-column align-items-center text-center">
                          ...
                          <div class="mt-3">
                            <h4>Add Role</h4>
                            <div class="col-md-12">
                              <input type="text" name="name" value="{{$role->name}}" class="form-control" id="exampleInputName" placeholder="Enter Name">
                            </div>
                            <br>
                            <div class="col-md-12">
                        ...
                        <div class="card-body">
                          ...
                          <div class="d-flex align-items-center gap-3">
                            ...
                            <div class="form-check form-switch">
                              <label class="form-check-label" for="flexSwitchCheckDefault1">{{ Form::checkbox('permission[]', $permissionValue->id, in_array($permissionValue->id, $rolePermissions) ? true : false, array('class' => 'name')) }}
                                {{ ucfirst($name[1]) }}
                              </label>
                            </div>
                            @endif
