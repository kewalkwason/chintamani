                        ...
                        <div class="col-lg-4">
                            <div class="page-header-breadcrumb">
                                <ul class="breadcrumb-title">
                                    ...
                                    <li class="breadcrumb-item" style="float: left;"> <a href="#!">Lead Management</a> </li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <div class="card mb-3 shadow no-b r-0">
                                            <div class="card-body">
                                                <div class="table-responsive">
                                                    <form action="{{route('lead_management.store')}}" enctype="multipart/form-data" class="form-inline" method="post" accept-charset="utf-8">
                                                        @csrf
                                                        <label class="col-form-label">Select Excel File * :</label>
                                                        <input class="form-control" type="file" name="uploadFile" required="" accept=".xls, .xlsx">
...
<script>
    ...
    var list = '{{ route("lead.management") }}';
    var titleName = 'Lead Management';
    $(document).ready(function() {
        table_schedule(list);
    });
